#ifndef SHAIYA_MOB_SPAWN_HEADER
#define SHAIYA_MOB_SPAWN_HEADER
...
namespace MobSpawnNotice {
	...
	void start() {
		...
		if (!GameConfiguration::IsFeatureEnabled("mob_spawn_notice")) {
			return;
		}

		g_wantObId  = GameConfiguration::GetInteger("mob_spawn_notice", "ob_id", 0);
		if (g_wantObId == 0) {
			return;
		}
