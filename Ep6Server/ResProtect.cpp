...
namespace resProtect
{
	...
	void start()
	{
		...
		objHook1.Hook((PVOID)g_hookAddr.resProtect1, Naked_RespawnProtected);
		objHook2.Hook((PVOID)g_hookAddr.resProtect2, Naked_RespawnProtected);
		objHook3.Hook((PVOID)g_hookAddr.resProtect3, Naked_RespawnProtected);
		objHook4.Hook((PVOID)g_hookAddr.resProtect4, Naked_RespawnProtected);
		objHook5.Hook((PVOID)g_hookAddr.resProtect5, Naked_RespawnProtected2, 6);
	}
}
