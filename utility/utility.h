...
#pragma pack(push,1)
	...
	struct TitleInfo :Header {
		bool isFirstPart{};
		PlayerTitle titles[50]{};
		DWORD addr1 = 0x0044bbe8;
		DWORD addr2 = 0x0044bca5;
		TitleInfo() :Header(Code::playerTitleCode) {}
	};
	...
	struct  EncodeNewHiddenMount:Header
	{
		WORD data_size{};
		BYTE encoded_data[1800]{};
		EncodeNewHiddenMount() :Header(hiddenMountCode)
		{
	...
	DWORD Shaiya11_Naked_fixCharacterRotate1 = 0x00412ebd;
	DWORD Shaiya11_Naked_fixboneId1 = 0x00412E87;
	DWORD Shaiya11_Naked_fixboneId2 = 0x00412EB0;
	DWORD Shaiya11_Naked_fixboneId3 = 0x00412EF6;
	DWORD Shaiya11_Naked_fixboneId5 = 0x00412FD6;
	DWORD Shaiya11_Naked_fixboneId7 = 0x00412F62;
	DWORD Shaiya11_Naked_fixHeight = 0x00434576;
