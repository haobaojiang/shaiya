...
DWORD WINAPI ThreadProc1(_In_  LPVOID lpParameter)
{
	...
	CMyInlineHook obj1((PVOID)0x0047f792, Naked_GetChatlog, &g_dwGetChatlogReturnAddr);
	g_pfunGetChatlog = GetChatlog;

	CMyInlineHook obj2((PVOID)0x00427938, Naked_CmpFaction, &g_dwCmpFactionReturnAddr, 6);
