...
__declspec(naked) void Naked_FixWareHouse()
{
	_asm
	{
		...
		GetWareHouse(ecx, edx, eax);
			popad
			add esp, 0x8         //原来push的2个参数我们没去调用原始的call,我们调出来
			jmp g_Hookobj_GetwareHouse_1.m_pRet
	}
}
...
// 			push eax
// 			push ecx          //pPlayer
// 			call g_Hookobj_WareHouse.m_pfun_call
			popad
			add esp, 0x8         //原来push的2个参数我们没去调用原始的call,我们调出来
			jmp g_Hookobj_WareHouse.m_pRet
	}
}
...
__declspec(naked) void Naked_FixTimer1()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_Hookobj_Timer1.m_pfun_call
		popad
		add esp,0x8
		jmp g_Hookobj_Timer1.m_pRet
	}
}
...
__declspec(naked) void Naked_FixHpOnLogin()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_HookObj_HpOnlogin.m_pfun_call
			popad
			add esp, 0x8
			jmp g_HookObj_HpOnlogin.m_pRet
	}
}
...
__declspec(naked) void Naked_FixShowSkill()
{
	_asm
	{
		pushad
			...
			push eax
			mov eax, [esp + 0x24]//packet buffer
			push eax
			push ecx             //pPlayer
			call HookObj_ShowKill.m_pfun_call
			popad
			add esp, 0x8
...
__declspec(naked) void Naked_autoStats()
{
	_asm
	{
		pushad
			push edi
			push ebx
			call g_objAutoStats.m_pfun_call
			popad
...
__declspec(naked) void Naked_sendquickslot()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx             //pPlayer
			call g_objSendQuickslot.m_pfun_call
			popad
			add esp,0x8
...
__declspec(naked) void Naked_market_readItem()
{
	_asm
	{
		pushad
		push edi        //pitem
		call g_objMarket_dyecolor.m_pfun_call
		popad
		//orgianl
		mov edi,eax
		imul edi,edi,0x3e8
...
__declspec(naked) void Naked_guildReadItem()
{
	_asm
	{
		...
		pushad
		push edi  //item
		call g_objGuild_readItem.m_pfun_call
		popad
...
__declspec(naked) void Naked_userStoredItems()
{
	_asm
	{
		...
		pushad
		push edi   //item
		call g_objRead_UserstoredItems.m_pfun_call
		popad
...
__declspec(naked) void Naked_readCharItemdetail()
{
	_asm
	{
		pushad
			push edi  //pitem
			call g_objReadCharItemDetail.m_pfun_call
			popad
...
__declspec(naked) void Naked_AddingtoFavorite()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketAddingtoFavorite.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketAddingtoFavorite.m_pRet
...
__declspec(naked) void Naked_CompletedMoney()
{
	_asm
	{
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketCompletedMoney.m_pfun_call
		popad
		add esp, 0x8
...
__declspec(naked) void Naked_SaleRegisteredItem()
{
	_asm
	{
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketSaleRegisteredItem.m_pfun_call
		popad
		add esp, 0x8
...
__declspec(naked) void Naked_InterestedItems()
{
	_asm
	{
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketInterestedItems.m_pfun_call
		popad
		add esp, 0x8
...
__declspec(naked) void Naked_CompeletedItem()
{
	_asm
	{
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketCompeltedItem.m_pfun_call
		popad
		add esp, 0x8
...
__declspec(naked) void Naked_Setitem()
{
	_asm
	{
		...
		pushad
		push esi
		call g_HookObj_Setitem.m_pfun_call
		popad
		sub esp, 0x8
...
__declspec(naked) void Naked_NewMountAppreance()
{
	_asm
	{
	   ...
	   g_objNewMountAppreance.m_pfun_call(edi, ebx, eax);

	//	push eax
	//	push ebx
	//	push edi   //player
	//	call g_objNewMountAppreance.m_pfun_call
...
__declspec(naked) void Naked_shopView()
{
	_asm
	{
		pushad
		push edi             //pshop
		mov eax, [esp + 0x2c] //packet size
		push eax
		mov eax, [esp + 0xc]//packet buffer
		push eax
		push ecx          //pPlayer
		call g_objShopView.m_pfun_call
		popad
		retn 0x8
	}
}
...
__declspec(naked) void Naked_RecivedTradeItem()
{
	_asm
	{
		...
		mov eax, [esp + 0x2c] //packet size
		push eax
		mov eax, [esp + 0x2c]//packet buffer
		push eax
		push ecx          //pPlayer
		call g_objRecivedTradeItem.m_pfun_call
		popad
		retn 0x8
	}
}
...
__declspec(naked) void Naked_DragTradeItem()
{
	_asm
	{
		...
		push eax
		push ecx          //pPlayer
		call g_objDragTradeItem.m_pfun_call
		popad
		retn 0x8
	}
}
...
__declspec(naked) void Naked_FixItemMall()
{
	_asm
	{
		...
		push eax
		push ecx          //pPlayer
		call g_objBuyItemmallItem.m_pfun_call
		popad
		add esp, 0x8         //原来push的2个参数我们没去调用原始的call,我们调出来
		jmp g_objBuyItemmallItem.m_pRet
	}
}
...
__declspec(naked) void Naked_Marketunknown_common()
{
	_asm
	{
		...
		push eax
		mov eax, [esp + 0x28]//packet buffer
		push eax
		push ecx           //pPlayer
		call g_objMarketUnknown[0].m_pfun_call
		popad
		retn 0x8
...
__declspec(naked) void Naked_CompletedAdditem_1()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketCompletedAdditem_1.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketCompletedAdditem_1.m_pRet

	}
}

__declspec(naked) void Naked_CompletedAdditem_2()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketCompletedAdditem_2.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketCompletedAdditem_2.m_pRet
...
__declspec(naked) void Naked_BuyMarketItem()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketBuyitem.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketBuyitem.m_pRet

	}
}

__declspec(naked) void Naked_bidMarket()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketBidItem.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketBidItem.m_pRet

	}
}

__declspec(naked) void Naked_receviedMarketItem()
{
	_asm
	{
		pushad
		...
		push eax
		push ecx           //pPlayer
		call g_objMarketRecivedItem.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarketRecivedItem.m_pRet
...
__declspec(naked) void Naked_RecivedMarketOnSaleInfo()
{
	_asm
	{
		...
		push eax
		push ecx           //pPlayer
		call g_objMarkectRecivedOnsale.m_pfun_call
		popad
		add esp, 0x8
		jmp g_objMarkectRecivedOnsale.m_pRet
...
__declspec(naked) void Naked_enterZoneNotice_2()
{
	_asm
	{
		...
		push ebx //packet
		push edi //player
		call g_objEnterZoneNotice_2.m_pfun_call
		popad
		add esp,0xc
...
__declspec(naked) void Naked_enterZoneNotice_1()
{
	_asm
	{
		...
		push eax //packet
		push ecx //player
		call g_objEnterZoneNotice_1.m_pfun_call
		popad
		add esp,0x8
...
__declspec(naked) void Naked_ConfrimCharName()
{
	_asm
	{
		pushad
			push edi    //PackBuffer
			push esi
			call g_objConfrimCharname.m_pfun_call
			popad
...
__declspec(naked) void Naked_DisableTransform()
{
	_asm
	{
		...
		pushad
			push ecx   //skill
			push esi   //player
			call g_objDisableTransform.m_pfun_call
			popad
...
__declspec(naked) void Naked_usetransform()
{
	_asm
	{
		push eax
			...
			push eax
			push edi
			call g_objuseTransform.m_pfun_call
			popad
...
__declspec(naked) void Naked_IllageFix1()
{
	_asm
	{
		pushad
			push ebp              //packets
			push ecx              //player
			call g_objIllageFix1.m_pfun_call
			popad
		add esp, 0x8
...
__declspec(naked) void Naked_sendDyeAppreance()
{
	_asm
	{
		pushad
			...
			push edi
			push edx                               //把包的内容改一下
			call g_objsendDyeAppreance.m_pfun_call
			popad
...
__declspec(naked) void Naked_enchantResult()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx           //pPlayer
			call g_objEnchantResult.m_pfun_call
			popad
			retn 0x8
...
__declspec(naked) void Naked_fixEnchant()
{
	_asm
	{
		pushad
			push esi
			push edi
			call g_ObjGetenchant.m_pfun_call
			popad
...
__declspec(naked) void Naked_MoveWhToWh()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_objMoveWhToWh.m_pfun_call
			popad
			add esp, 0x8
...
__declspec(naked) void Naked_MoveWhTobag()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_HookObj_MoveWhTobag.m_pfun_call
			popad
			add esp, 0x8
...
__declspec(naked) void Naked_MoveItem()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_objMoveitem.m_pfun_call
			popad
			add esp, 0x8
...
__declspec(naked) void Naked_MoveWhitem()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx           //pPlayer
			call g_objMoveWhItem.m_pfun_call
			popad
			add esp, 0x8
...
__declspec(naked) void Naked_FixTimer2()
{
	_asm
	{
		pushad
			...
			push eax
			push ecx          //pPlayer
			call g_Hookobj_Timer2.m_pfun_call
			popad
			add esp, 0x8
...
DWORD WINAPI ThreadProc1(_In_  LPVOID lpParameter)
{
	...
	//1.登陆处
	Hookobj_loginName.Hook((PVOID)0x0047b9b3, Naked_LoginNameFix);
	Hookobj_loginName.m_pfun_call = LoginNameFix;
	...
	g_objMarkectRecivedOnsale.Hook((PVOID)0x00440ff9, Naked_RecivedMarketOnSaleInfo, 5, fun_recivedMarketOnSaleInfo);
	...
	//22. item mall
	g_objBuyItemmallItem.Hook((PVOID)0x00488704, Naked_FixItemMall,5,fun_FixItemMall);
